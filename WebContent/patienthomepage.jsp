...
<form action="login" method="post">
            ...
            <h3>
				...
				<%= request.getAttribute("name") %>
                       ...
                       <table width="920" height="60" border="0">

              <tr>
                <td width="172">&nbsp;</td>
                <td width="738"><a href="/test5/showPatientInformation">View my information</a> </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><a href="updatePatientInformation.jsp">Update my basic information </a></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><a href="measuredataupdate.jsp">Upload measure data </a></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td height="29"><a href="/test5/selectDoctor">Select my doctor </a></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td height="29"><a href="/test5/showDoctorInformation">My doctor </a></td>
              </tr>
            </table>
            <p>
