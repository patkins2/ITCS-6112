...
<div>
<div>
<form action="showPatientInformation" method="post">
            <div>
            <h3>
				&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Please select a patient </h3>
				<div id="empTblContainer" class="container" ng-show="doctorList.length">
           		<table id="empTbl" class="table table-bordered marginTop14">
              		<thead>
                 		<tr>
                    		<th></th> <th>Username</th> <th>E-mail</th> 
                 		</tr>
              		</thead>
              		<tbody>
              		<%@ page import="java.util.List, cn.anxcyun.www.po.Patients" %>
						<%	List<Patients> l= (List<Patients>)request.getAttribute("patients");%>
                 		<% for(Patients d : l){ %>
								<tr><td><label>
								
                      <input type="radio" name="radiobutton" value="<%= d.getEmail() %>">
                      </label></td><td><%= d.getUsername() %></td><td><%= d.getEmail() %></td></tr>
						<%}%>
						<tr>
              		</tbody>
           		</table>
      ...
      &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      <input name="Save" type="submit" id=reg value="Check" />
      </p>
    </form>    
  </div>
</div>	
