...
<header>
  <div class="container">
    ...
    <div>
    <div>
      <form action="updatePatientInformation" method="post">
                  <div>
            <h3>
            ...
            <table width="1005" height="365" border="0">
			  ...
			  <tr>
                ...
                <td><input name="birthday" type="text" size="40"></td>
              </tr>
			  <tr>
                <td height="50">&nbsp;</td>
                <td><label>
                  <div align="center">Medical History :</div>
                  </label></td>
                <td><textarea name="medicalHistory" cols="50" rows="10"></textarea></td>
              </tr>
        </table>
		        <p>
